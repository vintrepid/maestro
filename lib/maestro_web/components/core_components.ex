defmodule MaestroWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MaestroWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MaestroWeb.Gettext, "errors", msg, opts)
    end
  end
