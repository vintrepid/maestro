      ...
      if resource do
        ...
        initial_params =
          if params["owner_type"],
            do: Map.put(initial_params, :owner_type, params["owner_type"]),
            else: initial_params

        initial_params =
          if params["owner_id"],
            do: Map.put(initial_params, :owner_id, params["owner_id"]),
            else: initial_params
        ...
        <div class="card bg-base-100 shadow-xl">
          <div class="card-body">
            <.form for={@form} phx-change="validate" phx-submit="save">
              <input
                type="hidden"
                name="form[owner_type]"
                value={@form.source.params["owner_type"] || "User"}
              />
              <input
                type="hidden"
                name="form[owner_id]"
                value={@form.source.params["owner_id"] || "1"}
              />
